...
public class TestMyDateTime {
	...
	public static void main(String[] args) {
		...
		// System.out.println(dateTime.toString()+ " is before " +
		// anotherDateTime.toString()+ " = " + before);
		// Expected output: 2017-03-29 00:30 is before 2017-03-29 15:30 = true

		// boolean after = dateTime.isAfter(anotherDateTime);
		// System.out.println(dateTime.toString()+ " is after " +
		// anotherDateTime.toString()+ " = " + after);
		...
		// System.out.print("Day time difference between " + dateTime.toString()+ " and
		// " + anotherDateTime.toString()+ " is " + dayTimeDiff);
		// Expected output: Day difference between 2017-03-29 00:30 and 2017-03-29 15:30
		// is 15 hour(s)
		...
		// System.out.print("Day time difference between " + dateTime.toString()+ " and
		// " + anotherDateTime.toString()+ " is " + dayTimeDiff);
		// Expected output: Day difference between 2017-03-29 00:30 and 2017-04-02 00:20
		// is 3 day(s) 23 hour(s) 50 minute(s)
